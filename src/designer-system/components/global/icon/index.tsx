    ...
    return (
        ...
        >
            ...
            >
                ...
                {icon === "eye-hide" && (
                    <Svg width={size} height={(size / 26) * 26} fill="none">
                        <Path
                            fill={color || "#5B5B5B"}
                            fillRule="evenodd"
                            d="M24.192 4.46a.82.82 0 1 0-1.024-1.28l-3.634 2.907C17.7 4.441 15.361 3 12.75 3c-2.34 0-4.456 1.158-6.174 2.564-1.727 1.414-3.139 3.151-4.088 4.473l-.078.109c-.571.793-1.042 1.447-1.042 2.418 0 .97.47 1.624 1.042 2.418l.078.109a26.904 26.904 0 0 0 2.296 2.796l-3.476 2.781a.82.82 0 1 0 1.024 1.28L24.192 4.46Zm-11.442.18c1.943 0 3.828 1.048 5.484 2.487l-2.86 2.288A4.099 4.099 0 0 0 9.1 14.433L6.07 16.859a25.1 25.1 0 0 1-2.25-2.725c-.681-.95-.811-1.178-.811-1.57 0-.392.13-.621.812-1.57.906-1.264 2.223-2.874 3.795-4.162C9.197 5.537 10.951 4.64 12.75 4.64Zm0 5.465c.477 0 .922.135 1.299.37l-3.622 2.898a2.46 2.46 0 0 1 2.323-3.268Z"
                            clipRule="evenodd"
                        />
                        <Path
                            fill={color || "#5B5B5B"}
                            d="M21.926 8.619a.82.82 0 1 0-1.27 1.037c.384.47.727.923 1.024 1.337.682.95.812 1.18.812 1.571 0 .392-.13.62-.812 1.57-.906 1.263-2.223 2.874-3.795 4.161-1.582 1.295-3.336 2.193-5.135 2.193-1.536 0-3.04-.653-4.44-1.659a.82.82 0 0 0-.957 1.332c1.557 1.118 3.394 1.967 5.397 1.967 2.34 0 4.456-1.158 6.174-2.564 1.727-1.414 3.139-3.151 4.088-4.473l.078-.109c.572-.794 1.042-1.447 1.042-2.418 0-.971-.47-1.624-1.042-2.418l-.078-.11c-.315-.437-.678-.918-1.086-1.417Z"
                        />
                        <Path
                            fill={color || "#5B5B5B"}
                            d="M16.849 12.564a.82.82 0 1 0-1.64 0 2.46 2.46 0 0 1-2.459 2.46.82.82 0 1 0 0 1.639 4.099 4.099 0 0 0 4.099-4.099Z"
                        />
                    </Svg>
                )}
